...
const Chat: NextPage = () => {
	...
	return (
		<>
			<Head>
				<title>{`Join our chat rooms in a second`}</title>
				<meta name='viewport' content='initial-scale=1.0, width=device-width' />
				<meta
					property='og:title'
					content={`Join our chat rooms in a second`}
					key='title'
				/>
				<meta
					name='keywords'
				...
				<meta
					name='description'
					content='These are chatrooms for made in PENN stack with socket.io, redux, tailwind-css, and chakraui.'></meta>
			</Head>
